    ...
    public static HashMap<Point,String> initialisePoints(int mapID) {
        ...
        switch (mapID) {
            ...
            case 1:
                ...
                points.put(new Point(5, 10), "The sign says 'SCIENCE LAB'.");
                points.put(new Point(16, 10), "The sign says 'COMPUTER LAB'.");
                break;
            ...
            case 2:
                ...
                points.put(new Point(2, 4), "I can can craft items here\nif I attend DT.");
                points.put(new Point(3, 4), "I can can craft items here\nif I attend DT.");
                points.put(new Point(2, 5), "I can can craft items here\nif I attend DT.");
                points.put(new Point(3, 5), "I can can craft items here\nif I attend DT.");
                points.put(new Point(4, 7), "I can can craft items here\nif I attend DT.");
                points.put(new Point(5, 7), "I can can craft items here\nif I attend DT.");
                points.put(new Point(4, 8), "I can can craft items here\nif I attend DT.");
                points.put(new Point(5, 8), "I can can craft items here\nif I attend DT.");
                ...
                points.put(new Point(15, 2), "This bookcase is filled with\nconstruction manuals.");
                points.put(new Point(16, 2), "This bookcase is filled with\nconstruction manuals.");
                break;

            /*Food Tech Classroom*/
            case 3:
                points.put(new Point(1, 2), "This bookcase is filled with\nrecipe books.");
                points.put(new Point(2, 2), "This bookcase is filled with\nrecipe books.");
                ...
                points.put(new Point(13, 4), "I can can cook here if I\nattend food tech.");
                points.put(new Point(14, 4), "I can can cook here if I\nattend food tech.");
                points.put(new Point(13, 6), "I can can cook here if I\nattend food tech.");
                points.put(new Point(14, 6), "I can can cook here if I\nattend food tech.");
                points.put(new Point(13, 8), "I can can cook here if I\nattend food tech.");
                points.put(new Point(14, 8), "I can can cook here if I\nattend food tech.");
                break;
            ...
            case 4:
                ...
                points.put(new Point(5, 4), "I should remember to wash my\nhands after working with\nchemicals!");
                points.put(new Point(5, 6), "I should remember to wash my\nhands after working with\nchemicals!");
                points.put(new Point(13, 1), "The whiteboard says 'Become\na computer genius with ICT!'.");
                points.put(new Point(14, 1), "The whiteboard says 'Become\na computer genius with ICT!'.");
                points.put(new Point(15, 1), "The whiteboard says 'Become\na computer genius with ICT!'.");
                points.put(new Point(19, 2), "This bookcase is filled with\nuser manuals for various\nsoftware.");
                points.put(new Point(20, 2), "This bookcase is filled with\nuser manuals for various\nsoftware.");
                points.put(new Point(12, 4), "I can improve my computer\nproficiency if I attend ICT.");
            ...
            /*Yard*/
            case 6:
                points.put(new Point(21, 17), "The sign says 'Come to PE to\nget good at sports!.");
                break;
        }
        return points;
